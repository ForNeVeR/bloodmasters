...
namespace CodeImp.Bloodmasters.Client
{
	public class Laser
	{
		...
		public static void Render(Vector3D from, Vector3D to)
		{
			...
			Direct3D.d3dd.RenderState.TextureFactor = General.ARGB(LASER_OPACITY[opacity], 1f, 1f, 1f);
			...
			// Render the dot
			Direct3D.d3dd.RenderState.TextureFactor = General.ARGB(dotalpha, 1f, 1f, 1f);
