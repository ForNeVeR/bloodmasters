...
public class HUD
{
    ...
    public HUD()
    {
        ...
        barverts = SharpDX.Direct3D9.Direct3D.TLRect(0f, 0.91f * (float)SharpDX.Direct3D9.Direct3D.DisplayHeight,
            (float)SharpDX.Direct3D9.Direct3D.DisplayWidth, (float)SharpDX.Direct3D9.Direct3D.DisplayHeight);
        ...
        healthicon = SharpDX.Direct3D9.Direct3D.LoadTexture(tempfile, true);
        tempfile = ArchiveManager.ExtractFile("General.zip/armoricon.tga");
        armoricon = SharpDX.Direct3D9.Direct3D.LoadTexture(tempfile, true);
        tempfile = ArchiveManager.ExtractFile("General.zip/red.bmp");
        flashtexture = SharpDX.Direct3D9.Direct3D.LoadTexture(tempfile, true);
        ...
        for(i = 0; i < (int)POWERUP.TOTAL_POWERUPS; i++)
        {
            ...
            powerupicons[i] = SharpDX.Direct3D9.Direct3D.LoadTexture(tempfile, true);
        }
        ...
        healthverts = SharpDX.Direct3D9.Direct3D.TLRect(0.016f * (float)SharpDX.Direct3D9.Direct3D.DisplayWidth,
            0.935f * (float)SharpDX.Direct3D9.Direct3D.DisplayHeight,
            0.052f * (float)SharpDX.Direct3D9.Direct3D.DisplayWidth,
            0.981f * (float)SharpDX.Direct3D9.Direct3D.DisplayHeight);

        // Setup health text
        healthtext = SharpDX.Direct3D9.Direct3D.CreateTextResource(General.charset_shaded);
        ...
        armorverts = SharpDX.Direct3D9.Direct3D.TLRect(0.208f * (float)SharpDX.Direct3D9.Direct3D.DisplayWidth,
            0.926f * (float)SharpDX.Direct3D9.Direct3D.DisplayHeight,
            0.253f * (float)SharpDX.Direct3D9.Direct3D.DisplayWidth,
            0.984f * (float)SharpDX.Direct3D9.Direct3D.DisplayHeight);

        // Setup armor text
        armortext = SharpDX.Direct3D9.Direct3D.CreateTextResource(General.charset_shaded);
        ...
        weaponverts = SharpDX.Direct3D9.Direct3D.TLRect(0.400f * (float)SharpDX.Direct3D9.Direct3D.DisplayWidth,
            0.930f * (float)SharpDX.Direct3D9.Direct3D.DisplayHeight,
            0.495f * (float)SharpDX.Direct3D9.Direct3D.DisplayWidth,
            0.995f * (float)SharpDX.Direct3D9.Direct3D.DisplayHeight);

        // Setup ammo text
        ammotext = SharpDX.Direct3D9.Direct3D.CreateTextResource(General.charset_shaded);
        ...
        powerupverts = SharpDX.Direct3D9.Direct3D.TLRect(0.634f * (float)SharpDX.Direct3D9.Direct3D.DisplayWidth,
            0.933f * (float)SharpDX.Direct3D9.Direct3D.DisplayHeight,
            0.678f * (float)SharpDX.Direct3D9.Direct3D.DisplayWidth,
            0.982f * (float)SharpDX.Direct3D9.Direct3D.DisplayHeight);

        // Setup powerup text
        poweruptext = SharpDX.Direct3D9.Direct3D.CreateTextResource(General.charset_shaded);
        ...
        // Setup score text
        scoretext = SharpDX.Direct3D9.Direct3D.CreateTextResource(General.charset_shaded);
        ...
        // Setup small message
        smallmessage = SharpDX.Direct3D9.Direct3D.CreateTextResource(General.charset_shaded);
        ...
        // Setup big message
        bigmessage = SharpDX.Direct3D9.Direct3D.CreateTextResource(General.charset_shaded);
        ...
        // Setup item message
        itemmessage = SharpDX.Direct3D9.Direct3D.CreateTextResource(General.charset_shaded);
        ...
        // Setup FPS text
        fps_text = SharpDX.Direct3D9.Direct3D.CreateTextResource(General.charset_shaded);
        ...
        // Setup MSPF text
        mspf_text = SharpDX.Direct3D9.Direct3D.CreateTextResource(General.charset_shaded);
        ...
        // Setup callvote text
        callvotetext = SharpDX.Direct3D9.Direct3D.CreateTextResource(General.charset_shaded);
    ...
    public void Process()
    {
        ...
        if (General.gamestate == GAMESTATE.COUNTDOWN)
        {
            ...
            int thiscountdown = (int)Math.Ceiling(((float)General.gamestateend - SharedGeneral.currenttime) / 1000f);
        ...
        if (General.callvotetimeout > 0)
        {
            // Determine countdown number in seconds
            int votecountdown
                = (int)Math.Ceiling(((float)General.callvotetimeout - (float)SharedGeneral.currenttime) / 1000f);

            // Remove callvote when countdown reaches 0
            if (votecountdown <= 0) General.callvotetimeout = 0;

            // Make the callvote text
            callvotetext.Text = "Votes for " + callvotedesc + ": " + General.callvotes + "  (callvote timeout: " +
                                votecountdown + ")";
        }
    ...
    public void RenderStatus()
    {
        ...
        if(!General.localclient.IsSpectator)
        {
            ...
            SharpDX.Direct3D9.Direct3D.d3dd.SetTexture(0, healthicon.texture);
            SharpDX.Direct3D9.Direct3D.d3dd.DrawUserPrimitives(PrimitiveType.TriangleStrip, 2, healthverts);
            healthtext.Text = General.localclient.Health.ToString();
            healthtext.Render();

            // Render the armor
            SharpDX.Direct3D9.Direct3D.d3dd.SetRenderState(RenderState.TextureFactor, -1);
            SharpDX.Direct3D9.Direct3D.d3dd.SetTexture(0, armoricon.texture);
            SharpDX.Direct3D9.Direct3D.d3dd.DrawUserPrimitives(PrimitiveType.TriangleStrip, 2, armorverts);
            ...
            if(General.localclient.CurrentWeapon != null)
            {
                ...
                SharpDX.Direct3D9.Direct3D.d3dd.DrawUserPrimitives(PrimitiveType.TriangleStrip, 2, weaponverts);
            ...
            if(General.localclient.Powerup != POWERUP.NONE)
            {
                ...
                // Render the powerup
                SharpDX.Direct3D9.Direct3D.d3dd.SetRenderState(RenderState.TextureFactor, -1);
                SharpDX.Direct3D9.Direct3D.d3dd.SetTexture(0, powerupicons[pid - 1].texture);
                SharpDX.Direct3D9.Direct3D.d3dd.DrawUserPrimitives(PrimitiveType.TriangleStrip, 2, powerupverts);
                poweruptext.Render();
            }
    ...
    public void RenderMessages()
    {
        ...
        if(HUD.showhud)
        {
            ...
            {
                // Render small message
                SharpDX.Direct3D9.Direct3D.d3dd.SetRenderState(RenderState.TextureFactor, General.ARGB(smallfade, 1f, 1f, 1f));
                smallmessage.Render();
            }
            ...
            {
                // Render big message
                SharpDX.Direct3D9.Direct3D.d3dd.SetRenderState(RenderState.TextureFactor, General.ARGB(bigfade, 1f, 1f, 1f));
                bigmessage.Render();
            }
            ...
            {
                // Render big message
                SharpDX.Direct3D9.Direct3D.d3dd.SetRenderState(RenderState.TextureFactor, General.ARGB(itemfade, 1f, 1f, 1f));
                itemmessage.Render();
            }
        }
    }
