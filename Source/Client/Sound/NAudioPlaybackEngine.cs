...
namespace CodeImp.Bloodmasters.Client
{
    class NAudioPlaybackEngine : IDisposable
    {
        ...
        public void Dispose() // TODO: Make sure we call this on app termination somehow
        {
            _outputDevice.Dispose();
        }

        public static readonly NAudioPlaybackEngine Instance = new(); // TODO: Get rid of this
    }
}
