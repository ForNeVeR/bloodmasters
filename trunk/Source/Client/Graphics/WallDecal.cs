		...
		public override void Render()
		{
			...
			if((sector.InScreen) && (texture != null))
			{
				...
				if((sc != null) && sc.Dynamic)
				{
					...
					Direct3D.d3dd.Transform.World = decalmatrix * m;
				}
				else
				{
					// Reset world matrix
					Direct3D.d3dd.Transform.World = decalmatrix;
				}
				
				// Apply lightmap matrix
				Direct3D.d3dd.Transform.Texture1 = lightmapmatrix;
				...
				// Set transparency
				Direct3D.d3dd.RenderState.TextureFactor = base.fadecolor;
