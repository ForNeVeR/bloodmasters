...
{
	public class IonExplodeLight : DynamicLight
	{
		#region ================== Constants

		private const int CHANGE_INTERVAL = 60;
		private const float CHANGE_BRIGHT_SCALE = 0.14f;
		...
		// Constructor
		public IonExplodeLight(Vector3D spawnpos) :
			base(spawnpos, 30f, General.ARGB(1f, 0.4f, 0.5f, 1f), 1)
		{
			// Start
