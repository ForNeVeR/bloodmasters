	...
	public class Bullet : VisualObject
	{
		...
		public override void Render()
		{
			...
			if(flashalpha > 0f)
			{
				...
				if(flashalpha > 1f)
					Direct3D.d3dd.RenderState.TextureFactor = General.ARGB(1f, 0.8f, 0.7f, 0.4f);
				else
					Direct3D.d3dd.RenderState.TextureFactor = General.ARGB(flashalpha, 0.8f, 0.7f, 0.4f);
				
				// Apply matrices
				Direct3D.d3dd.Transform.World = matflash;
