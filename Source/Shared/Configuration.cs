...
namespace CodeImp
{
	...
	public interface IConfiguration
	{
		...
		string ReadSetting(string setting, string defaultsetting);
		string ReadSetting(string setting, string defaultsetting, string pathseperator);
		int ReadSetting(string setting, int defaultsetting);
		int ReadSetting(string setting, int defaultsetting, string pathseperator);
		float ReadSetting(string setting, float defaultsetting);
		float ReadSetting(string setting, float defaultsetting, string pathseperator);
		short ReadSetting(string setting, short defaultsetting);
		short ReadSetting(string setting, short defaultsetting, string pathseperator);
		long ReadSetting(string setting, long defaultsetting);
		long ReadSetting(string setting, long defaultsetting, string pathseperator);
		bool ReadSetting(string setting, bool defaultsetting);
		bool ReadSetting(string setting, bool defaultsetting, string pathseperator);
		byte ReadSetting(string setting, byte defaultsetting);
