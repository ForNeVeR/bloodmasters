...
namespace CodeImp.Bloodmasters.Client
{
	public class Sprite
	{
		...
		public void Render()
		{
			...
			if(lightmapped)
			{	
				Direct3D.d3dd.Transform.Texture1 = matlightmap;
				Direct3D.d3dd.Transform.Texture2 = matdynlightmap * General.arena.LightmapMatrix;
			}
			...
			Direct3D.d3dd.Transform.World = Matrix.Multiply(matsprite, apos);
